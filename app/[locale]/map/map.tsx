      ...
      <AnimatePresence>
        {showFirePointId !== 0 && (
          <motion.div
            ...
            exit={{ opacity: 0, x: 0 }}
            className='absolute right-0 top-1/2 z-10 max-w-96 transform rounded-xl bg-white bg-opacity-85 p-6 duration-100 dark:bg-gray-950 dark:bg-opacity-80 md:right-32'
          >
            <div
